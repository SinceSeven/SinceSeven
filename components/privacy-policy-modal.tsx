      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[80vh] overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto max-h-[60vh]">
          <div className="prose prose-sm max-w-none dark:prose-invert">
            <h3 className="text-lg font-semibold mb-3">Защита на личните данни</h3>
            <p className="mb-4">
              SinceSeven се ангажира да защитава вашата лична информация и да зачита правото ви на поверителност.
            </p>
            ...
            <p className="mb-4">
              <strong>Контакт:</strong> За всякакви въпроси относно тази политика за поверителност, 
              моля свържете се с нас на <a href="mailto:info@sinceseven.bg" className="text-primary hover:underline">info@sinceseven.bg</a>
            </p>
